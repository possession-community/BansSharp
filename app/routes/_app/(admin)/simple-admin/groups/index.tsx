...
import { getGroups } from "~/lib/functions/simple-admin/group";
      ...
      <Main>
        <div className="mb-2 flex flex-wrap items-center justify-between space-y-2">
          <div className="flex items-center">
            ...
            <h2 className="text-1xl font-bold tracking-tight">Groups</h2>
          </div>
          <SimpleAdminPrimaryButtons />
        </div>

        <div className="-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-x-12 lg:space-y-0">
          <SimpleAdminTable whichTable="groups" />
        </div>
      </Main>
...
export const Route = createFileRoute("/_app/(admin)/simple-admin/groups/")({
  beforeLoad: async () => {},
  ...
  component: () => (
    <SimpleAdminProvider initialTab="groups">
      <GroupsContent />
    </SimpleAdminProvider>
  ),
});
